const countries = [
  ...
  let containerimg=document.getElementById("Card");
 


let res= countries.map(ele=>{
    return ` 
    <div class="col-md-3 mb-4">
        <figure class="figimg">
            <img   class="image" src="${ele.flag}"alt="flag" title="flag">
            <div class="row">
                <div class="col-12">
                    <figcaption class="figCap text-center">
                        <h4 class="head">Name:
                            ${ele.name}
                        </h4>
                        <p class="para"><b>Capital</b>: ${ele.capital}</p>
                        <p class="para"><b>Languages </b>:${ele.languages}</p>

                        <p class="para"><b> Population </b>:${ele.population}</p>
